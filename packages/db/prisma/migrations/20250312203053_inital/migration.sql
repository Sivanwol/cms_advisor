...
-- CreateIndex
CREATE INDEX "stations_polygonGroupId_idx" ON "stations"("polygonGroupId");
...
-- CreateIndex
CREATE INDEX "otp_code_driver_id_idx" ON "otp_code"("driver_id");

-- CreateIndex
CREATE INDEX "otp_code_employee_id_idx" ON "otp_code"("employee_id");
